...
let ensureTicketingSchema;
try {
  ensureTicketingSchema = require('../modules/tickets/bootstrap').ensureTicketingSchema;
} catch (error) {
  logger.error('Failed to import ticket bootstrap:', error.message);
  ensureTicketingSchema = null;
}
